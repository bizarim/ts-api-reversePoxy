...
let HeartController = class HeartController {
    constructor(heartService) {
        this.heartService = heartService;
    }
    login() {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.heartService.beat();
        });
    }
};
__decorate([
